...
#endif
#if defined (__unix__) || defined (__APPLE__) || defined (UNIXCOMMON) || defined (__3DS__) //3ds has this too
	#include <strings.h>
	#undef stricmp
...
// 3ds already has these
#if defined (_WIN32) || defined (__HAIKU__) || defined (__3DS__)
...
#ifndef __cplusplus
#ifndef _WIN32
#ifdef __3DS__   // already defined somewhere
#undef false
#undef true
#endif
enum {false = 0, true = 1};
